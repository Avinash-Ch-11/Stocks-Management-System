...
<form name="f1" action="MEas" onsubmit = "return validation()" method="post">
			<table style="with: 50%">
				<tr>
					<td>ssn</td>
...
<script>  
            ...
            {  
                ...
                if(ssn.length=="" || fn.length=="" || ln.length=="" || add.length=="" || city.length=="" || state.length=="" || zc.length=="" || tp.length=="" || hr.length=="" || ps.length=="" || un.length=="" || pwd.length=="") {  
